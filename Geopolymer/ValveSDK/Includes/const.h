...
#define ABSOLUTE_PLAYER_LIMIT 255  // not 256, so we can send the limit as a char 
...
#define MAX_CUSTOM_FILE_SIZE	524288	// Half a megachar
...
#define MAX_AREA_STATE_charS		32
#define MAX_AREA_PORTAL_STATE_charS 24
