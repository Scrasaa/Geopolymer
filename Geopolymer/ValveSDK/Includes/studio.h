...
struct mstudioquatinterpbone_t
{
	...
	int numtriggers;
	int triggerindex;
	inline mstudioquatinterpinfo_t* pTrigger(int i) const { return  (mstudioquatinterpinfo_t*)(((char*)this) + triggerindex) + i; };
};
...
struct mstudiobone_t
{
	...
	inline void* pProcedure() const { if (procindex == 0) return NULL; else return  (void*)(((char*)this) + procindex); };
	int surfacepropidx;
...
struct mstudiolinearbone_t
{
	int numbones;
	int flagsindex;
	inline int flags(int i) const { return *((int*)(((char*)this) + flagsindex) + i); };
	inline int* pflags(int i) { return ((int*)(((char*)this) + flagsindex) + i); };
	int	parentindex;
	inline int parent(int i) const { return *((int*)(((char*)this) + parentindex) + i); };
	int	posindex;
	inline Vector pos(int i) const { return *((Vector*)(((char*)this) + posindex) + i); };
	int quatindex;
	inline Quaternion quat(int i) const { return *((Quaternion*)(((char*)this) + quatindex) + i); };
	int rotindex;
	inline Vector rot(int i) const { return *((Vector*)(((char*)this) + rotindex) + i); };
	int posetoboneindex;
	inline matrix3x4_t* poseToBone(int i) const { return ((matrix3x4_t*)(((char*)this) + posetoboneindex) + i); };
	int	posscaleindex;
	inline Vector posscale(int i) const { return *((Vector*)(((char*)this) + posscaleindex) + i); };
	int	rotscaleindex;
	inline Vector rotscale(int i) const { return *((Vector*)(((char*)this) + rotscaleindex) + i); };
	int	qalignmentindex;
	inline Quaternion qalignment(int i) const { return *((Quaternion*)(((char*)this) + qalignmentindex) + i); };
	int unused[6];
};
...
struct mstudioboneflexdriver_t
{
	...
	{
		return (mstudioboneflexdrivercontrol_t*)(((char*)this) + m_nControlIndex) + i;
	}
...
struct mstudiocompressedikerror_t
{
	float scale[6];
	short offset[6];
	inline mstudioanimvalue_t* pAnimvalue(int i) const { if (offset[i] > 0) return  (mstudioanimvalue_t*)(((char*)this) + offset[i]); else return NULL; };
};
...
struct mstudioikrule_t
{
	...
	inline mstudiocompressedikerror_t* pCompressedError() const { return (mstudiocompressedikerror_t*)(((char*)this) + compressedikerrorindex); };
	int unused2;
	int iStart;
	int ikerrorindex;
	inline mstudioikerror_t* pError(int i) const { return  (ikerrorindex) ? (mstudioikerror_t*)(((char*)this) + ikerrorindex) + (i - iStart) : NULL; };
	float start;
	float peak;
	float tail;
	float end;
...
struct mstudiolocalhierarchy_t
{
	...
	int iStart;
	int localanimindex;
	inline mstudiocompressedikerror_t* pLocalAnim() const { return (mstudiocompressedikerror_t*)(((char*)this) + localanimindex); };
	int unused[4];
};
...
struct mstudioanim_t
{
	char bone;
	char flags;
	inline char* pData(void) const { return (((char*)this) + sizeof(struct mstudioanim_t)); };
	...
	short nextoffset;
	inline mstudioanim_t* pNext(void) const { if (nextoffset != 0) return  (mstudioanim_t*)(((char*)this) + nextoffset); else return NULL; };
};
...
{
	int baseptr;
	inline studiohdr_t* pStudiohdr(void) const { return (studiohdr_t*)(((char*)this) + baseptr); }
	int sznameindex;
	inline char* const pszName(void) const { return ((char*)this) + sznameindex; }
	float fps;
	int flags;
	...
	int nummovements;
	int movementindex;
	inline mstudiomovement_t* const pMovement(int i) const { return (mstudiomovement_t*)(((char*)this) + movementindex) + i; };
	int unused1[6];
	int animblock;
	int animindex;
	int numikrules;
	...
	int sectionindex;
	int sectionframes;
	inline mstudioanimsections_t* const pSection(int i) const { return (mstudioanimsections_t*)(((char*)this) + sectionindex) + i; }
	short zeroframespan;
	short zeroframecount;
	int zeroframeindex;
	char* pZeroFrameData() const { if (zeroframeindex) return (((char*)this) + zeroframeindex); else return NULL; };
...
{
	int sznameindex;
	inline char* pszName() { return (sznameindex) ? (char*)(((char*)this) + sznameindex) : NULL; }
};
...
struct mstudioseqdesc_t
{
	...
	int numevents;
	int eventindex;
	inline mstudioevent_t* pEvent(int i) const { return (mstudioevent_t*)(((char*)this) + eventindex) + i; };
	Vector bbmin;
	Vector bbmax;
	int numblends;
	int animindexindex;
	...
	int numautolayers;
	int autolayerindex;
	inline mstudioautolayer_t* pAutolayer(int i) const { return (mstudioautolayer_t*)(((char*)this) + autolayerindex) + i; };
	int weightlistindex;
	inline float* pBoneweight(int i) const { return ((float*)(((char*)this) + weightlistindex) + i); };
	inline float weight(int i) const { return *(pBoneweight(i)); };
	int posekeyindex;
	float* pPoseKey(int iParam, int iAnim) const { return (float*)(((char*)this) + posekeyindex) + iParam * groupsize[0] + iAnim; }
	float poseKey(int iParam, int iAnim) const { return *(pPoseKey(iParam, iAnim)); }
	int numiklocks;
	int iklockindex;
	inline mstudioiklock_t* pIKLock(int i) const { return (mstudioiklock_t*)(((char*)this) + iklockindex) + i; };
	int keyvalueindex;
	int keyvaluesize;
	...
	inline mstudioactivitymodifier_t* pActivityModifier(int i) const { return activitymodifierindex != 0 ? (mstudioactivitymodifier_t*)(((char*)this) + activitymodifierindex) + i : NULL; };
	int unused[5];
};
...
struct mstudioflex_t
{
	...
	int numverts;
	int vertindex;
	inline mstudiovertanim_t* pVertanim(int i) const { return (mstudiovertanim_t*)(((char*)this) + vertindex) + i; };
	inline mstudiovertanim_wrinkle_t* pVertanimWrinkle(int i) const { return  (mstudiovertanim_wrinkle_t*)(((char*)this) + vertindex) + i; };
	inline char* pBaseVertanim() const { return ((char*)this) + vertindex; };
	inline int	VertAnimSizechars() const { return (vertanimtype == STUDIO_VERT_ANIM_NORMAL) ? sizeof(mstudiovertanim_t) : sizeof(mstudiovertanim_wrinkle_t); }
	int flexpair;
...
struct mstudioflexrule_t
{
	...
	int numops;
	int opindex;
	inline mstudioflexop_t* iFlexOp(int i) const { return  (mstudioflexop_t*)(((char*)this) + opindex) + i; };
};
...
struct mstudioikchain_t
{
	...
	int numlinks;
	int linkindex;
	inline mstudioiklink_t* pLink(int i) const { return (mstudioiklink_t*)(((char*)this) + linkindex) + i; };
};
...
struct mstudiomesh_t
{
	...
	int numflexes;
	int flexindex;
	inline mstudioflex_t* pFlex(int i) const { return (mstudioflex_t*)(((char*)this) + flexindex) + i; };
	int materialtype;
	int materialparam;
	int meshid;
	Vector center;
...
struct mstudiomodel_t
{
	...
	int nummeshes;
	int meshindex;
	inline mstudiomesh_t* pMesh(int i) const { return (mstudiomesh_t*)(((char*)this) + meshindex) + i; };
	int numvertices;
	int vertexindex;
	int tangentsindex;
	int numattachments;
	...
	int numeyeballs;
	int eyeballindex;
	inline  mstudioeyeball_t* pEyeball(int i) { return (mstudioeyeball_t*)(((char*)this) + eyeballindex) + i; };
...
struct mstudiobodyparts_t
{
	...
	int base;
	int modelindex;
	inline mstudiomodel_t* pModel(int i) const { return (mstudiomodel_t*)(((char*)this) + modelindex) + i; };
};
...
public:
	const mstudiovertex_t* GetVertexData() const
	{
		if ((id == MODEL_VERTEX_FILE_ID) && (vertexDataStart != 0))
			return (mstudiovertex_t*)(vertexDataStart + (char*)this);
		else
			return NULL;
	}
	...
	const void* GetTangentData() const
	{
		if ((id == MODEL_VERTEX_FILE_ID) && (tangentDataStart != 0))
			return (void*)(tangentDataStart + (char*)this);
		else
			return NULL;
	}
	...
	const thinModelVertices_t* GetThinVertexData() const
	{
		if ((id == MODEL_VERTEX_FILE_THIN_ID) && (vertexDataStart != 0))
			return (thinModelVertices_t*)(vertexDataStart + (char*)this);
		else
			return NULL;
	}
};
...
struct studiohdr2_t
{
	...
	int linearboneindex;
	inline mstudiolinearbone_t* pLinearBones() const { return (linearboneindex) ? (mstudiolinearbone_t*)(((char*)this) + linearboneindex) : NULL; }
	int sznameindex;
	inline char* pszName() { return (sznameindex) ? (char*)(((char*)this) + sznameindex) : NULL; }
	int m_nBoneFlexDriverCount;
	int m_nBoneFlexDriverIndex;
	inline mstudioboneflexdriver_t* pBoneFlexDriver(int i) const { return (mstudioboneflexdriver_t*)(((char*)this) + m_nBoneFlexDriverIndex) + i; }
	int reserved[56];
};
...
struct studiohdr_t
{
	...
	int numbones;
	int boneindex;
	inline mstudiobone_t* pBone(int i) const { return (mstudiobone_t*)(((char*)this) + boneindex) + i; };
	int numbonecontrollers;
	int bonecontrollerindex;
	inline mstudiobonecontroller_t* pBonecontroller(int i) const { return (mstudiobonecontroller_t*)(((char*)this) + bonecontrollerindex) + i; };
	int numhitboxsets;
	int hitboxsetindex;
	...
	int numlocalanim;
	int localanimindex;
	inline mstudioanimdesc_t* pLocalAnimdesc(int i) const { if (i < 0 || i >= numlocalanim) i = 0; return (mstudioanimdesc_t*)(((char*)this) + localanimindex) + i; };
	int numlocalseq;
	int localseqindex;
	inline mstudioseqdesc_t* pLocalSeqdesc(int i) const { if (i < 0 || i >= numlocalseq) i = 0; return (mstudioseqdesc_t*)(((char*)this) + localseqindex) + i; };
	int activitylistversion;
	int eventsindexed;
	int numtextures;
	int textureindex;
	inline mstudiotexture_t* pTexture(int i) const { return (mstudiotexture_t*)(((char*)this) + textureindex) + i; };
	int numcdtextures;
	int cdtextureindex;
	inline char* pCdtexture(int i) const { return (((char*)this) + *((int*)(((char*)this) + cdtextureindex) + i)); };
	int numskinref;
	int numskinfamilies;
	int skinindex;
	inline short* pSkinref(int i) const { return (short*)(((char*)this) + skinindex) + i; };
	int numbodyparts;
	int bodypartindex;
	inline mstudiobodyparts_t* pBodypart(int i) const { return (mstudiobodyparts_t*)(((char*)this) + bodypartindex) + i; };
	int numlocalattachments;
	int localattachmentindex;
	inline mstudioattachment_t* pLocalAttachment(int i) const { return (mstudioattachment_t*)(((char*)this) + localattachmentindex) + i; };
	int numlocalnodes;
	int localnodeindex;
	int localnodenameindex;
	inline char* pszLocalNodeName(int iNode) const { return (((char*)this) + *((int*)(((char*)this) + localnodenameindex) + iNode)); }
	inline char* pLocalTransition(int i) const { return (char*)(((char*)this) + localnodeindex) + i; };
	int numflexdesc;
	int flexdescindex;
	inline mstudioflexdesc_t* pFlexdesc(int i) const { return (mstudioflexdesc_t*)(((char*)this) + flexdescindex) + i; };
	int numflexcontrollers;
	int flexcontrollerindex;
	inline mstudioflexcontroller_t* pFlexcontroller(LocalFlexController_t i) const { return (mstudioflexcontroller_t*)(((char*)this) + flexcontrollerindex) + i; };
	int numflexrules;
	int flexruleindex;
	inline mstudioflexrule_t* pFlexRule(int i) const { return (mstudioflexrule_t*)(((char*)this) + flexruleindex) + i; };
	int numikchains;
	int ikchainindex;
	inline mstudioikchain_t* pIKChain(int i) const { return (mstudioikchain_t*)(((char*)this) + ikchainindex) + i; };
	int nummouths;
	int mouthindex;
	inline mstudiomouth_t* pMouth(int i) const { return (mstudiomouth_t*)(((char*)this) + mouthindex) + i; };
	int numlocalposeparameters;
	int localposeparamindex;
	inline mstudioposeparamdesc_t* pLocalPoseParameter(int i) const { return (mstudioposeparamdesc_t*)(((char*)this) + localposeparamindex) + i; };
	...
	inline mstudioiklock_t* pLocalIKAutoplayLock(int i) const { return (mstudioiklock_t*)(((char*)this) + localikautoplaylockindex) + i; };
	float mass;
	int contents;
	int numincludemodels;
	int includemodelindex;
	inline mstudiomodelgroup_t* pModelGroup(int i) const { return (mstudiomodelgroup_t*)(((char*)this) + includemodelindex) + i; };
	void* virtualModel;
	int szanimblocknameindex;
	inline char* const pszAnimBlockName(void) const { return ((char*)this) + szanimblocknameindex; }
	int numanimblocks;
	int animblockindex;
	inline mstudioanimblock_t* pAnimBlock(int i) const { return (mstudioanimblock_t*)(((char*)this) + animblockindex) + i; };
	void* animblockModel;
	int bonetablebynameindex;
	inline const char* GetBoneTableSortedByName() const { return (char*)this + bonetablebynameindex; }
	void* pVertexBase;
	void* pIndexBase;
	...
	mstudioflexcontrollerui_t* pFlexControllerUI(int i) const { return (mstudioflexcontrollerui_t*)(((char*)this) + flexcontrolleruiindex) + i; }
	...
	int unused3[1];
	int studiohdr2index;
	studiohdr2_t* pStudioHdr2() const { return (studiohdr2_t*)(((char*)this) + studiohdr2index); }
	int NumSrcBoneTransforms() const { return studiohdr2index ? pStudioHdr2()->numsrcbonetransform : 0; }
	const mstudiosrcbonetransform_t* SrcBoneTransform(int i) const { return (mstudiosrcbonetransform_t*)(((char*)this) + pStudioHdr2()->srcbonetransformindex) + i; }
...
struct flexsetting_t
{
	...
	{
		return (char*)(((char*)this) + nameindex);
	}
...
struct flexsettinghdr_t
{
	...
	inline flexsetting_t* pSetting(int i) const { return (flexsetting_t*)(((char*)this) + flexsettingindex) + i; };
	int nameindex;
	int numindexes;
	int indexindex;
	...
	inline flexsetting_t* pIndexedSetting(int index) const
	{
		...
		int i = *((int*)(((char*)this) + indexindex) + index);
	...
	int numkeys;
	int keynameindex;
	inline char* pLocalName(int i) const { return (char*)(((char*)this) + *((int*)(((char*)this) + keynameindex) + i)); };
	int keymappingindex;
	inline int* pLocalToGlobal(int i) const { return (int*)(((char*)this) + keymappingindex) + i; };
