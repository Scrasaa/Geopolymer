...
public:
	...
	{
		g_Memory->GetVTableFunction<void(__thiscall*)(void*, ITexture*)>(this, 6)(this, pTexture);
	}

	void DepthRange(float zNear, float zFar)
	{
		g_Memory->GetVTableFunction<void(__thiscall*)(void*, float, float)>(this, 11)(this, zNear, zFar);
	}
...
public:
	...
	virtual void Init(char const* pShaderAPIDLL, IMaterialProxyFactory* pMaterialProxyFactory, void* fileSystemFactory, void* cvarFactory = NULL) = 0;
	...
	virtual void* CreateRenderContext(MaterialContextType_t type) = 0;
	...
	virtual ITexture* CreateTextureFromBits(int w, int h, int mips, ImageFormat fmt, int srcBufferSize, char* srcBits) = 0;
	...
	virtual void AsyncFindTexture(const char* pFilename, const char* pTextureGroupName, void* pRecipient, void* pExtraArgs, bool bComplain = true, int nAdditionalCreationFlags = 0) = 0;
	virtual ITexture* CreateNamedTextureFromBitsEx(const char* pName, const char* pTextureGroupName, int w, int h, int mips, ImageFormat fmt, int srcBufferSize, char* srcBits, int nFlags) = 0;
};