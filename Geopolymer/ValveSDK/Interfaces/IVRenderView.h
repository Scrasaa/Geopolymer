...
public:
	...
	virtual void			ViewDrawFade(char* color, IMaterial* pMaterial) = 0;
	...
	virtual void			SetAreaState(unsigned char chAreaBits[MAX_AREA_STATE_charS], unsigned char chAreaPortalBits[MAX_AREA_PORTAL_STATE_charS]) = 0;
